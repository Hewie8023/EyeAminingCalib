...
int main()
{
    ...
    Mat image = imread("C:\\Users\\Hewie\\Desktop\\001.jpg",1);//"C:\\Users\\mby\\Desktop\\QQ截图20181121192125.jpg"
    Mat proc;
    double in[5];
    VideoCapture cap(0);
    ...
    //cvMoveWindow("Image:", 100, 100);
            ...
            resize(image, proc, Size(0, 0), 1, 1, 1);
